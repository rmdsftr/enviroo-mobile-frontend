...
class JadwalBsiMendatangScreen extends StatefulWidget {
  @override
  State<JadwalBsiMendatangScreen> createState() => _JadwalBsiMendatangState();
}

class _JadwalBsiMendatangState extends State<JadwalBsiMendatangScreen> {
  @override
