...
import 'package:enviroo/screens/admin_bsi/qr_distribusi_sembako_screen.dart';
...
class PreviewDistribusiSembakoScreen extends StatelessWidget {
  ...
  Future<void> _lanjutScan(BuildContext context) async {
    ...
    final res = await sembako.generateQrDistribusi(
      bsiId: bsiId,
      bsuId: bsuId,
    ...
    final result = await Navigator.push<String>(
      context,
      MaterialPageRoute(
        builder: (_) => QrDistribusiSembakoScreen(
          disbakoId: res['disbako_id'] as String,
          namaBsu: namaBsu,
          bsuId: bsuId,
        ),
      ),
