...
class ScanRedeemScreen extends StatefulWidget {
  const ScanRedeemScreen({super.key});
...
class _ScanRedeemScreenState extends State<ScanRedeemScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      context.read<RedeemBsiProvider>().bind(auth);
    });
  }
  ...
  Future<void> _verifyAndOpen(String transaksiId) async {
    ...
    final ok = await prov.verifikasiManual(transaksiId);
    ...
    await Navigator.pushReplacement(
      context,
      MaterialPageRoute(
        builder: (_) => DetailVerifikasiBsiScreen(transaksiId: transaksiId),
      ),
    );
  }
