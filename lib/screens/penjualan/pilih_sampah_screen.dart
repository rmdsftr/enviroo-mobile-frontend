...
class _PilihSampahScreenState extends State<PilihSampahScreen> {
  ...
  Future<void> _fetchKatalog(String bankId) async {
    ...
    await katalog.fetchKatalogSampah(bankId);
    if (!mounted) return;
    if (katalog.errorMessage == null) {
      ...
      setState(() {
        _error = katalog.errorMessage ?? 'Gagal mengambil katalog';
      });
    }
  }
                    ...
                    children: [
                      ...
                      Expanded(
                        child: _InputField(
                          ...
                          label: 'Harga Jual',
                          prefix: isBarang ? null : 'Rp',
                          suffix: isBarang ? rewardSatuan : null,
                          onChanged: (v) {
