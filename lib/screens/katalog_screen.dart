...
class KatalogScreen extends StatefulWidget {
  final String role;
  const KatalogScreen({super.key, this.role = 'nasabah'});
...
class _KatalogScreenState extends State<KatalogScreen> {
    ...
    return Padding(
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color:
                isSelected ? _C.accent.withValues(alpha:0.1) : Colors.white,
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(
                  ...
                  fontSize: 12,
                  fontWeight: FontWeight.w600,
                  color: isSelected ? _C.accent : _C.dark.withValues(alpha:0.5),
                  letterSpacing: -0.2,
                ),
              ),
            ],
  ...
  Widget _buildCard(KatalogSampahModel item) {
    final isPetugas = widget.role.startsWith('petugas');
  ...
  Widget _buildPlaceholder(IconData icon) {
    return Container(
      ...
      child: Center(
        child: Icon(icon, size: 36, color: _C.accent.withValues(alpha:0.5)),
      ),
    );
  }
